    ...
    <div class="wholeWrap">
        <div class="equWrap">
            ...
            <div class="tab">
                ...
                <v-search-list v-on:ids="getIdsFn" v-bind:other="otherInfo" v-bind:label="info" v-bind:list="equList" v-on:receive="btnFn" v-bind:curPage="currentPage" v-bind:tabShow="tabShow"></v-search-list>
